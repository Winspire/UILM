...
<?php
       ...
       $form_attr = array('id' => 'invitationform', 'class' => 'form-horizontal row-border' , 'enctype' => 'multipart/form-data');
        echo form_open('inviteustemp/send_inquiry',$form_attr);
?>
...
<div class="wow fadeInRight" data-wow-delay="0.4s">      
<img src="inviteustemp/captcha" id="captcha" /><br/>


<!-- CHANGE TEXT LINK -->
<a onclick="
    document.getElementById('captcha').src='inviteustemp/captcha?'+Math.random();
