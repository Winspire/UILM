...
class emailsetting extends CI_Controller {
    ...
    public function index() {
        $this->data['settings'] = $this->common->get_all_record('emailsetting');
    ...
    public function edit($id) {
        ...
        $settingvalue=$this->common->select_database_id('emailsetting','settingid',$settingid);
        ...
        if ($this->input->post()) {
            ...
            if ($this->form_validation->run() == FALSE) {
                $this->load->view('emailsetting/edit', $this->data);
            } else {
                $data = array(
                ...
                if($this->common->update_data($data,'emailsetting','settingid',$this->data['settingid']))
                {
                    $this->session->set_flashdata('success',$this->data['settingname'].' updated successfully');
                    redirect('emailsetting', 'refresh');
                    
                }
 else {$this->load->view('emailsetting/edit', $this->data);}
