...
| For more event please see the user guide:
|
...
| native libraries.  For more event please see the user guide:
|
...
| GMT.  See the 'date helper' page of the user guide for event
...
$config['doctor_thumb_image_height'] = '205';
$config['doctor_thumb_image_width'] = '205';
